...
const SOURCE_REFS=Object.freeze({
  berry_strength:['Serebii Pokémon Sleep berry strength level tables'],
...
export function buildProductionEvidenceSnapshot({candidateFeatures={},weeklyContext={},productionRegistry=currentProductionAuthorityRegistry()}={}){
  ...
  const rules=Object.freeze([
    ...
    freezeRow({dimension:'berry_energy_per_berry',authority_status:status('berry_energy_per_berry'),evidence_status:EVIDENCE_STATUS.REFERENCE_EVIDENCE_IDENTIFIED,coverage:coverage(0,total),runtime_numeric_activation:false,source_refs:SOURCE_REFS.berry_strength,blocking_reasons:['LOCAL_BERRY_STRENGTH_BY_LEVEL_MASTER_MISSING']}),
