...
export const INGREDIENT_PROBABILITY_INDEPENDENT_SOURCE_ADMISSION_ID='ingredient-probability-independent-source-admission-2026-08-17-b';
export const INGREDIENT_PROBABILITY_INDEPENDENT_SOURCE_ADMISSION_VERSION='ingredient-probability-independent-source-admission-v2';
...
export const INDEPENDENT_SOURCE_ADMISSION_REQUIREMENTS=Object.freeze([
  ...
  'NO_FORK_OR_MIRROR_OF_PRIMARY_NUMERIC_LINEAGE',
...
export function evaluateIndependentIngredientProbabilitySourceAdmission(source={}){
  ...
  const primaryOverlap=source.overlaps_primary_numeric_lineage===true;
  const primaryForkOrMirror=source.fork_or_mirror_of_primary_numeric_lineage===true||source.derived_from_neroli_primary===true||source.mirror_of_neroli_primary===true;
  if(primaryOverlap||primaryForkOrMirror)return freeze({
    status:INDEPENDENT_SOURCE_ADMISSION_STATUS.REJECTED_PRIMARY_LINEAGE,
    reason:primaryOverlap?'OVERLAPPING_PRIMARY_NUMERIC_LINEAGE_CANNOT_BE_INDEPENDENT':'PRIMARY_LINEAGE_OR_MIRROR_CANNOT_BE_INDEPENDENT',
    independence_status:INDEPENDENT_CROSSCHECK_SOURCE_STATUS.DERIVED_OR_MIRROR_OF_PRIMARY,
