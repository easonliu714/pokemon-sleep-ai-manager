...
export const PROMPT_CATALOG={
  ...
  capacity:wrap('帳號容量更新','使用 scenario=capacity。辨識鍋子、食材包、道具包與寶可夢盒容量；capacity_key 僅用 pot、ingredient_bag、item_bag、pokemon_box。無法確認的容量填 null。',['account_capacity'],{total_capacity:null,used_count:null},'capacity'),
