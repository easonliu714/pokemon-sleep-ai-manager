...
export const PUBLIC_BERRY_STRENGTH_VERSION='public-berry-strength-2026-08-13-a';
...
const BASE_ROWS=Object.freeze([
  ['一般','柿仔果','Persim Berry',28],['火','蘋野果','Leppa Berry',27],['水','橙橙果','Oran Berry',31],['電','葡萄果','Grepa Berry',25],
...
export function berryStrengthAuthority(berryName){return BY_BERRY.get(text(berryName))||null;}
...
export function resolveBerryStrength(berryName,levelValue){
  const berry_name=text(berryName),authority=berryStrengthAuthority(berry_name),level=validLevel(levelValue);
