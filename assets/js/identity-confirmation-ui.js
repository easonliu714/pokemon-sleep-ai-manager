...
export function renderIdentityConfirmationQueue(container,queue,{onDecide}={}){
  ...
  container.innerHTML=`<section class="identity-confirmation" aria-label="寶可夢身分確認">
    <header class="identity-confirmation__header">
      ...
      <output>${items.filter(item=>item.state==='confirmed'||item.state==='skipped').length}/${items.length}</output>
    </header>
...
.identity-confirmation{display:grid;gap:16px}.identity-confirmation__header{display:flex;justify-content:space-between;gap:16px;align-items:start}.identity-confirmation__header h2{margin:0}.identity-confirmation__header p{margin:.35rem 0 0}.identity-confirmation__header output{font-weight:700;white-space:nowrap}.identity-confirmation__list{display:grid;gap:12px}.identity-confirmation__card{border:1px solid #d8dde6;border-radius:16px;padding:14px;background:var(--surface,#fff);display:grid;gap:12px}.identity-confirmation__title-row{display:flex;justify-content:space-between;gap:12px}.identity-confirmation__title-row div{display:grid;gap:4px}.identity-confirmation__title-row span,.identity-confirmation__state{font-size:.85rem}.identity-confirmation__evidence{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0}.identity-confirmation__evidence div{background:#f5f7fa;border-radius:10px;padding:8px}.identity-confirmation__evidence dt{font-size:.75rem}.identity-confirmation__evidence dd{margin:3px 0 0;font-weight:600;overflow-wrap:anywhere}.identity-confirmation__candidate{display:grid;gap:6px}.identity-confirmation__candidate select,.identity-confirmation__actions button{min-height:44px;font:inherit}.identity-confirmation__actions{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}@media(max-width:560px){.identity-confirmation__evidence{grid-template-columns:1fr}.identity-confirmation__actions{grid-template-columns:1fr}.identity-confirmation__card{padding:12px;border-radius:14px}}
`;
