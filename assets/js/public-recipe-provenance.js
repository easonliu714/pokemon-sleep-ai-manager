...
export const PUBLIC_RECIPE_PROVENANCE_VERSION='public-recipe-provenance-2026-08-14-b-current-name-authority';
...
const NAME_EVIDENCE_BY_SOURCE_TYPE=Object.freeze({
...
export const PUBLIC_RECIPE_PROVENANCE=Object.freeze(PUBLIC_RECIPE_MASTER.map(recipe=>{
  ...
  const nameEvidence=NAME_EVIDENCE_BY_SOURCE_TYPE[recipe.source_type]||'CURRENT_AUTHORITY_OTHER';
  return Object.freeze({
    ...
    name_source_type:recipe.source_type,
    name_source_name:recipe.source_name,
    name_source_ref:recipe.source_ref,
    name_observed_at:recipe.verified_at,
    ...
    reference_match_basis:activatedAug12?'in_game_zh_tw_name+exact_ingredient_formula+reference_crosscheck':correctedParentChildFormula?'current_in_game_detail+exact_ingredient_formula+two_reference_crosscheck':recipe.source_type==='game_screenshot_verified'?'category+ingredient_signature+in_game_zh_tw_name':recipe.source_type==='game_screenshot_reference_crosscheck'?'current_name+reference_crosscheck':'current_reference_crosscheck',
    overall_status:activatedAug12?'ACTIVE_CURRENT_GAME_NAME_FORMULA_VERIFIED':correctedParentChildFormula?'ACTIVE_CURRENT_GAME_FORMULA_CORRECTED_REFERENCE_CROSSCHECKED':screenshotVerifiedFormula?'ACTIVE_SCREENSHOT_FORMULA_VERIFIED':nameEvidence==='GAME_SCREENSHOT_VERIFIED'?'ACTIVE_SCREENSHOT_NAME_REFERENCE_FORMULA':nameEvidence==='GAME_SCREENSHOT_REFERENCE_CROSSCHECK'?'ACTIVE_NAME_REFERENCE_CROSSCHECKED':'ACTIVE_CURRENT_REFERENCE_NAME_FORMULA',
