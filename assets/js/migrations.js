...
export function applyCanonicalTerminologyMigration(db){applyPublicCandyMasterSchema(db);applyCanonicalRegistry(db);db.run(`INSERT OR IGNORE INTO schema_migrations(version,applied_at) VALUES(6,datetime('now'))`);}
