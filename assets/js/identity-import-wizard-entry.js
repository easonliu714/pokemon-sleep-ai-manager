...
const style=document.createElement('style');style.id='identityImportWizardStyles';style.textContent='.identity-import-summary,.data1-review-summary,.ocr-review-summary{display:grid;grid-template-columns:repeat(auto-fit,minmax(110px,1fr));gap:8px;margin-bottom:10px}.identity-import-summary>div,.data1-review-summary>div,.ocr-review-summary>div{border:1px solid #dfe8e3;border-radius:10px;padding:10px;background:#fff}.tech2d-file-picker-actions{display:grid;grid-template-columns:1fr 1fr;gap:8px}.ocr-review-list{display:grid;gap:8px;max-height:420px;overflow:auto}.ocr-review-item{border:1px solid #dfe8e3;border-radius:10px;padding:10px;background:#fff;display:grid;gap:4px}@media(max-width:560px){.identity-import-summary,.data1-review-summary,.ocr-review-summary{grid-template-columns:repeat(2,minmax(0,1fr))}.tech2d-file-picker-actions{grid-template-columns:1fr}}';if(!document.getElementById(style.id))document.head.appendChild(style);void renderCore();
