...
gate('release and offline wiring retain v0.4.27.47 exact predecessor',()=>{
  ...
  }else if(currentAppVersion==='v0.4.27.55.3.3.2'){
    assert.equal(currentAppBuild,'20260906-v042755332-ai-key-update-status-knowledge-host');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.2-v042755332-ai-key-update-status-knowledge-host');
    assert.ok(versionSource.includes("// app_version: 'v0.4.27.47'"),'Gemini/update-status successor must retain exact P0-B2 v0.4.27.47 lineage marker');
    assert.ok(versionSource.includes("// app_build: '20260829-v042747-p0b2-public-species-authority'"),'Gemini/update-status successor must retain exact P0-B2 build lineage marker');
    assert.ok(versionSource.includes("// cache_name: 'pokemon-sleep-ai-v0.4.27.47-v042747-p0b2-public-species-authority'"),'Gemini/update-status successor must retain exact P0-B2 cache lineage marker');
  }else if(currentAppVersion==='v0.4.27.55.3.3.3'){
    assert.equal(currentAppBuild,'20260907-v042755333-candy-master-progressive-render');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.3-v042755333-candy-master-progressive-render');
  ...
  }else if(currentAppVersion==='v0.4.27.55.3.3.5'){
    assert.equal(currentAppBuild,'20260908-v042755335-g121a-authority-closure');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.5-v042755335-g121a-authority-closure');
  ...
  }else if(currentAppVersion==='v0.4.27.55.3.3.7'){
    assert.equal(currentAppBuild,'20260911-v042755337-g121d-real-device-closure');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.7-v042755337-g121d-real-device-closure');
    assert.ok(versionSource.includes("// app_version: 'v0.4.27.47'"),'G12.1D/E real-device closure successor must retain exact P0-B2 v0.4.27.47 lineage marker');
    assert.ok(versionSource.includes("// app_build: '20260829-v042747-p0b2-public-species-authority'"),'G12.1D/E real-device closure successor must retain exact P0-B2 build lineage marker');
    assert.ok(versionSource.includes("// cache_name: 'pokemon-sleep-ai-v0.4.27.47-v042747-p0b2-public-species-authority'"),'G12.1D/E real-device closure successor must retain exact P0-B2 cache lineage marker');
    assert.ok(versionSource.includes("// app_version: 'v0.4.27.55.3.3.6'"),'G12.1D/E real-device closure successor must retain exact .55.3.3.6 predecessor marker');
  }else if(currentAppVersion==='v0.4.27.55.3.3.8'){
    assert.equal(currentAppBuild,'20260913-v042755338-g121-authority-parity-real-device-closure');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.8-v042755338-g121-authority-parity-real-device-closure');
    assert.ok(versionSource.includes("// app_version: 'v0.4.27.47'"),'G12.1 authority-parity successor must retain exact P0-B2 v0.4.27.47 lineage marker');
    assert.ok(versionSource.includes("// app_build: '20260829-v042747-p0b2-public-species-authority'"),'G12.1 authority-parity successor must retain exact P0-B2 build lineage marker');
    assert.ok(versionSource.includes("// cache_name: 'pokemon-sleep-ai-v0.4.27.47-v042747-p0b2-public-species-authority'"),'G12.1 authority-parity successor must retain exact P0-B2 cache lineage marker');
  ...
  }else if(currentAppVersion==='v0.4.27.55.3.3.9'){
    assert.equal(currentAppBuild,'20260914-v042755339-duration-berry-visual-authority');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.9-v042755339-duration-berry-visual-authority');
    assert.ok(versionSource.includes("// app_version: 'v0.4.27.47'"),'.55.3.3.9 successor must retain exact P0-B2 v0.4.27.47 lineage marker');
    assert.ok(versionSource.includes("// app_build: '20260829-v042747-p0b2-public-species-authority'"),'.55.3.3.9 successor must retain exact P0-B2 build lineage marker');
    assert.ok(versionSource.includes("// cache_name: 'pokemon-sleep-ai-v0.4.27.47-v042747-p0b2-public-species-authority'"),'.55.3.3.9 successor must retain exact P0-B2 cache lineage marker');
  ...
  }else if(currentAppVersion==='v0.4.27.55.3.3.12'){
    assert.equal(currentAppBuild,'20260920-v0427553312-weekly-review-navigation-real-device-closure');
    assert.equal(currentCacheName,'pokemon-sleep-ai-v0.4.27.55.3.3.12-v0427553312-weekly-review-navigation-real-device-closure');
    assert.ok(versionSource.includes("// app_version: 'v0.4.27.47'"),'.55.3.3.12 successor must retain exact P0-B2 v0.4.27.47 lineage marker');
    assert.ok(versionSource.includes("// app_build: '20260829-v042747-p0b2-public-species-authority'"),'.55.3.3.12 successor must retain exact P0-B2 build lineage marker');
    assert.ok(versionSource.includes("// cache_name: 'pokemon-sleep-ai-v0.4.27.47-v042747-p0b2-public-species-authority'"),'.55.3.3.12 successor must retain exact P0-B2 cache lineage marker');
