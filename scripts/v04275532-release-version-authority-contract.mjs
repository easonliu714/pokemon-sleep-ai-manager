...
assert.ok(live.includes(`app_version: '${successor336.version}'`) || live.includes(`app_version: '${successor335.version}'`) || live.includes(`app_version: '${successor334.version}'`) || live.includes(`app_version: '${successor333.version}'`) || live.includes(`app_version: '${successor332.version}'`) || live.includes(`app_version: '${successor331.version}'`) || live.includes(`app_version: '${successor.version}'`) || live.includes(`app_version: '${predecessor.version}'`), 'live authority must be .55.3.2 through governed .55.3.3.6 successor');
if(live.includes(`app_version: '${successor336.version}'`)){
...
console.log('v0.4.27.55.3.2 predecessor through .55.3.3.6 successor release authority contract: PASS');
