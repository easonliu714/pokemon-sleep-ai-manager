...
const releases = Object.freeze([
  ...
  Object.freeze({
    version: 'v0.4.27.55.3.3.10',
    build: '20260917-v0427553310-real-device-followup',
    cache: 'pokemon-sleep-ai-v0.4.27.55.3.3.10-v0427553310-real-device-followup',
  }),
  Object.freeze({
    version: 'v0.4.27.55.3.3.11',
