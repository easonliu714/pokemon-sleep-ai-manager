...
if(appVersion==='v0.4.27.55.3.3.11'){
  ...
  for(const predecessor of ['v0.4.27.55.3.3.8','v0.4.27.55.3.3.7','v0.4.27.55.3.3.6','v0.4.27.55.3.3.5','v0.4.27.55.3.3.4','v0.4.27.55.3.3.3','v0.4.27.55.3.3.2','v0.4.27.55.3.3.1','v0.4.27.55.3.3','v0.4.27.55.3','v0.4.27.55.2','v0.4.27.55'])assert.ok(version.includes(`// app_version: '${predecessor}'`),`duration/berry successor must retain predecessor authority marker ${predecessor}`);
}else if(appVersion==='v0.4.27.55.3.3.8'){
  assert.ok(ui.includes("section.dataset.performanceAuthority='v0.4.27.55.3-mobile-incremental-confirmation'"),'G12.1 authority-parity successor must preserve the exact .55.3 Candy performance authority');
  ...
  for(const predecessor of ['v0.4.27.55.3.3.7','v0.4.27.55.3.3.6','v0.4.27.55.3.3.5','v0.4.27.55.3.3.4','v0.4.27.55.3.3.3','v0.4.27.55.3.3.2','v0.4.27.55.3.3.1','v0.4.27.55.3.3','v0.4.27.55.3','v0.4.27.55.2','v0.4.27.55'])assert.ok(version.includes(`// app_version: '${predecessor}'`),`G12.1 authority-parity successor must retain predecessor authority marker ${predecessor}`);
}else if(appVersion==='v0.4.27.55.3.3.7'){
  assert.ok(ui.includes("section.dataset.performanceAuthority='v0.4.27.55.3-mobile-incremental-confirmation'"),'G12.1D/E real-device closure successor must preserve the exact .55.3 Candy performance authority');
  ...
  for(const predecessor of ['v0.4.27.55.3.3.6','v0.4.27.55.3.3.5','v0.4.27.55.3.3.4','v0.4.27.55.3.3.3','v0.4.27.55.3.3.2','v0.4.27.55.3.3.1','v0.4.27.55.3.3','v0.4.27.55.3','v0.4.27.55.2','v0.4.27.55'])assert.ok(version.includes(`// app_version: '${predecessor}'`),`G12.1D/E real-device closure successor must retain predecessor authority marker ${predecessor}`);
}else if(appVersion==='v0.4.27.55.3.3.6'){
  assert.ok(ui.includes("section.dataset.performanceAuthority='v0.4.27.55.3-mobile-incremental-confirmation'"),'G12.1D/E successor must preserve the exact .55.3 Candy performance authority');
  ...
  for(const predecessor of ['v0.4.27.55.3.3.5','v0.4.27.55.3.3.4','v0.4.27.55.3.3.3','v0.4.27.55.3.3.2','v0.4.27.55.3.3.1','v0.4.27.55.3.3','v0.4.27.55.3','v0.4.27.55.2','v0.4.27.55'])assert.ok(version.includes(`// app_version: '${predecessor}'`),`G12.1D/E successor must retain predecessor authority marker ${predecessor}`);
  ...
  assert.ok(version.includes("// app_version: 'v0.4.27.55.3.3.1'"),'Gemini/update/knowledge successor must retain .55.3.3.1 predecessor authority marker');
  assert.ok(version.includes("// app_version: 'v0.4.27.55.3.3'"),'Gemini/update/knowledge successor must retain .55.3.3 predecessor authority marker');
  assert.ok(version.includes("// app_version: 'v0.4.27.55.3'"),'Gemini/update/knowledge successor must retain .55.3 predecessor authority marker');
  assert.ok(version.includes("// app_version: 'v0.4.27.55.2'"),'Gemini/update/knowledge successor must retain .55.2 predecessor authority marker');
  assert.ok(version.includes("// app_version: 'v0.4.27.55'"),'Gemini/update/knowledge successor must retain .55 predecessor authority marker');
