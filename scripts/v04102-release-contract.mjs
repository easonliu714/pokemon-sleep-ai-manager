...
assert.ok(['v0.4.10.2','v0.4.10.3','v0.4.11','v0.4.11.1','v0.4.11.2'].includes(appVersion),`unexpected v0.4.10.2 successor: ${appVersion}`);
...
assert.equal(migrations.includes('VALUES(10,'),false,'v0.4.10.2 lineage must remain schema-migration-free through v0.4.11.2');
