...
// the exact release-version whitelist advances through .55.3.3.8.
assert.match(versionSource,/app_version: 'v0\.4\.27\.55\.3(?:\.[12]|\.3(?:\.[12345678])?)?'/);
...
assert.match(globalThis.PokemonSleepVersionAuthority?.app_version||'',/^v0\.4\.27\.55\.3(?:\.[12]|\.3(?:\.[12345678])?)?$/);
