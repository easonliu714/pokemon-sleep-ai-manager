...
assert.equal(appVersion,'v0.3.57');
assert.equal(build,'20260803-data1d1-two-stage-ocr-versioned-exports');
assert.equal(cache,'pokemon-sleep-ai-v0.3.57-data1d1-two-stage-ocr-versioned-exports');
