...
assert.match(CLASSIFIER_SCHEMA,/^pokemon-sleep-ocr-first-classifier\/1\.[4-9]\d*$/,'classifier_schema_must_preserve_or_advance_v1_4_contract');
...
assert.ok(joint.classification_evidence.some(value=>value.toLowerCase().includes('sp')),'sp_evidence_missing');
