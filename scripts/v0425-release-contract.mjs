...
assert.ok(['v0.4.25','v0.4.26','v0.4.27'].includes(authority.app_version));
if(authority.app_version==='v0.4.27'){
  ...
  assert.ok(authoritySource.includes("// app_build: '20260814-v0426-g75e3a-ingredient-rate-reference-boundary'"));
