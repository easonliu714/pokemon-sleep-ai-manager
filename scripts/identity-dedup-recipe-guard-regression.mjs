...
assert.match(bootstrap,/APP_VERSION = 'v0\.3\.30'/);
assert.match(bootstrap,/20260731-profile-completeness-guard1/);
assert.match(sw,/pokemon-sleep-ai-v0\.3\.30-profile-completeness-guard/);
console.log('PASS profile completeness identity guard and existing UI contracts');
