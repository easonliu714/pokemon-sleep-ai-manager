...
assert.match(bootstrap,/APP_VERSION = 'v0\.3\.33'/);
assert.match(bootstrap,/20260801-tech2d-import-wizard/);
assert.match(bootstrap,/identity-import-wizard-entry\.js/);
assert.match(bootstrap,/pokemon-screenshot-grouping\.js/);
assert.match(sw,/pokemon-sleep-ai-v0\.3\.33-tech2d-import-wizard/);
...
console.log('PASS profile completeness identity guard and TECH.2D UI/PWA contracts');
