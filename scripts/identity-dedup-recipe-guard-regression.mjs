...
assert.match(bootstrap,/APP_VERSION = 'v0\.3\.31'/);
assert.match(bootstrap,/20260731-ai-observation-v2a1/);
assert.match(sw,/pokemon-sleep-ai-v0\.3\.31-ai-observation-v2a1/);
