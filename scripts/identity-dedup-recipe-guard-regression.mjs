...
assert.match(bootstrap,/APP_VERSION = 'v0\.3\.34'/);
assert.match(bootstrap,/20260801-tech2d-zip-transaction/);
assert.match(bootstrap,/identity-import-wizard-entry\.js/);
assert.match(bootstrap,/pokemon-screenshot-grouping\.js/);
assert.match(bootstrap,/pokemon-zip-manifest\.js/);
assert.match(bootstrap,/identity-import-transaction\.js/);
assert.match(sw,/pokemon-sleep-ai-v0\.3\.34-tech2d-zip-transaction/);
assert.match(sw,/identity-import-pipeline\.js/);
assert.match(sw,/pokemon-screenshot-grouping\.js/);
assert.match(sw,/pokemon-zip-manifest\.js/);
assert.match(sw,/identity-import-transaction\.js/);
assert.match(sw,/identity-import-wizard-entry\.js/);
console.log('PASS profile completeness identity guard and TECH.2D ZIP/transaction PWA contracts');
