...
assert.match(bootstrap,/APP_VERSION = 'v0\.3\.36'/);
assert.match(bootstrap,/20260801-tech2d-android-import/);
...
assert.match(sw,/pokemon-sleep-ai-v0\.3\.36-tech2d-android-import/);
...
console.log('PASS profile completeness identity guard and TECH.2D Android ZIP/offline PWA contracts');
