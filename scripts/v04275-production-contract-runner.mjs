...
const unchangedProductionReleases=new Set([
  'v0.4.27.5','v0.4.27.6','v0.4.27.7','v0.4.27.8','v0.4.27.9','v0.4.27.10','v0.4.27.11',
  'v0.4.27.55.3.3.10',
]);
if(!unchangedProductionReleases.has(current)){
  ...
  // v0.4.27.11 budgets model candidates and persists successful runtime fallback only.
  // v0.4.27.55.3.3.10 is a narrow real-device successor closure for duration,
  // business telemetry, UC.IMG-A visual review/observability and mobile navigation.
  // It does not change Production numeric authority. Replay Production behavioral
