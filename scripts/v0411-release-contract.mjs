...
assert.ok(['v0.4.11','v0.4.11.1','v0.4.11.2','v0.4.11.3','v0.4.11.4','v0.4.12','v0.4.13','v0.4.13.1'].includes(appVersion),`unexpected v0.4.11 successor: ${appVersion}`);
const exactReleases={
...
if(appVersion==='v0.4.13.1')for(const predecessor of ['v0.4.13','v0.4.12','v0.4.11.4','v0.4.11.3','v0.4.11.2','v0.4.11.1'])assert.ok(version.includes(`// app_version: '${predecessor}'`),`v0.4.13.1 must retain ${predecessor} legacy bridge`);
