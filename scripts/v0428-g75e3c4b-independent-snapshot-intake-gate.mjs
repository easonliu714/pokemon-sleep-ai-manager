...
const wrongRosterCount=validateIndependentIngredientProbabilitySnapshot({snapshot:{...partialSnapshot,source:{...admittedSource(3),roster_row_count:241}},rosterKeys});
assert.equal(wrongRosterCount.status,INDEPENDENT_SNAPSHOT_INTAKE_STATUS.SNAPSHOT_REVIEW_REQUIRED);
