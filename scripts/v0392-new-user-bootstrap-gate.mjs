...
requireText(database,'BOOT_PERSIST_SKIPPED','unchanged version skip-persist path');
requireText(database,"persistRequired=!restored||Boolean(migrationResult?.database_changed)",'conditional boot persist');
...
requireText(migrations,'force:true','fresh database force-loads public masters');
