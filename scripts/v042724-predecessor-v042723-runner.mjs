...
if(current!=='v0.4.27.24')throw new Error(`V042724_PREDECESSOR_UNEXPECTED_VERSION:${current}`);
...
console.log(JSON.stringify({status:'PASS',gate:'V042724_PREDECESSOR_V042723_REPLAY',current_version:current,staged_version:'v0.4.27.23',contracts,current_authority_restored:true},null,2));
