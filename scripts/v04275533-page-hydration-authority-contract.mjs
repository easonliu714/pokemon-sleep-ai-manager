...
const releases={
  'v0.4.27.55.3.3':{build:'20260904-v04275533-page-hydration-authority',cache:'pokemon-sleep-ai-v0.4.27.55.3.3-v04275533-page-hydration-authority'},
  'v0.4.27.55.3.3.1':{build:'20260905-v042755331-page-prewarm-collapsible-hydration',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.1-v042755331-page-prewarm-collapsible-hydration'},
  'v0.4.27.55.3.3.2':{build:'20260906-v042755332-ai-key-update-status-knowledge-host',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.2-v042755332-ai-key-update-status-knowledge-host'},
  'v0.4.27.55.3.3.3':{build:'20260907-v042755333-candy-master-progressive-render',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.3-v042755333-candy-master-progressive-render'},
  'v0.4.27.55.3.3.4':{build:'20260908-v042755334-page-status-visibility-watchdog',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.4-v042755334-page-status-visibility-watchdog'},
  'v0.4.27.55.3.3.5':{build:'20260908-v042755335-g121a-authority-closure',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.5-v042755335-g121a-authority-closure'},
  'v0.4.27.55.3.3.6':{build:'20260910-v042755336-g121d-evolution-recommendation-ui',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.6-v042755336-g121d-evolution-recommendation-ui'},
  'v0.4.27.55.3.3.7':{build:'20260911-v042755337-g121d-real-device-closure',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.7-v042755337-g121d-real-device-closure'},
  'v0.4.27.55.3.3.8':{build:'20260913-v042755338-g121-authority-parity-real-device-closure',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.8-v042755338-g121-authority-parity-real-device-closure'},
  ...
  'v0.4.27.55.3.3.13':{build:'20260926-v0427553313-g14-derived-state-authority',cache:'pokemon-sleep-ai-v0.4.27.55.3.3.13-v0427553313-g14-derived-state-authority'},
};
...
const ordered=['v0.4.27.55.3.3','v0.4.27.55.3.3.1','v0.4.27.55.3.3.2','v0.4.27.55.3.3.3','v0.4.27.55.3.3.4','v0.4.27.55.3.3.5','v0.4.27.55.3.3.6','v0.4.27.55.3.3.7','v0.4.27.55.3.3.8','v0.4.27.55.3.3.9','v0.4.27.55.3.3.10','v0.4.27.55.3.3.11','v0.4.27.55.3.3.12','v0.4.27.55.3.3.13'];
...
for(const token of ['canonicalizeImportHistoryDom','knowledgePokemonSlot','knowledgeCandySlot','single_owner_render:true','update_center_real_mount_gate:true',"document.getElementById('candyQuantityScreenshotB5')","document.getElementById('analysisConfirmationWorkbench')"]) assert.ok(hydrator.includes(token),'missing .55.3.3 hydration contract token: '+token);
...
console.log(JSON.stringify({gate:'V04275533_PAGE_HYDRATION_AUTHORITY',status:'PASS',version:appVersion,navigation_is_data_mutation:false,single_owner_render:true,deferred_double_render_removed:true,knowledge_fixed_slots:true,update_center_real_mount_gate:true,import_history_single_owner:true,migration:CANDY_FAMILY_STORAGE_MIGRATION_VERSION},null,2));
if(currentIndex>=1)await import('./v042755331-page-prewarm-collapsible-hydration-contract.mjs');
