...
assert.ok(['v0.4.17.1','v0.4.18','v0.4.19'].includes(appVersion),`unexpected G7.4 release/successor version ${appVersion}`);
if(['v0.4.18','v0.4.19'].includes(appVersion))assert.ok(version.includes("// app_version: 'v0.4.17.1'"),`${appVersion} must retain v0.4.17.1 lineage bridge`);
