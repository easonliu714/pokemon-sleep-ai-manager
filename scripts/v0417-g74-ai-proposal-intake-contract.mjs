...
assert.ok(['v0.4.17.1','v0.4.18'].includes(appVersion),`unexpected G7.4 release/successor version ${appVersion}`);
if(appVersion==='v0.4.18')assert.ok(version.includes("// app_version: 'v0.4.17.1'"),'v0.4.18 must retain v0.4.17.1 lineage bridge');
