...
const pagePrewarmSuccessor=['v0.4.27.55.3.3.1','v0.4.27.55.3.3.2','v0.4.27.55.3.3.3','v0.4.27.55.3.3.4','v0.4.27.55.3.3.5','v0.4.27.55.3.3.6'].includes(appVersion);
...
if(pagePrewarmSuccessor){
  ...
  if(appVersion==='v0.4.27.55.3.3.1'){
    ...
    assert.equal(appVersion,'v0.4.27.55.3.3.6');
