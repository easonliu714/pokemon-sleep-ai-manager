...
assert.ok(['v0.4.10.3','v0.4.11','v0.4.11.1'].includes(appVersion),`unexpected v0.4.10.3 successor: ${appVersion}`);
...
if(appVersion==='v0.4.11'||appVersion==='v0.4.11.1'){
...
assert.equal(migrations.includes('VALUES(10,'),false,'v0.4.10.3 lineage through v0.4.11.1 must remain schema-migration-free');
...
console.log(JSON.stringify({
  ...
  public_master_constrained_successor:appVersion==='v0.4.11'||appVersion==='v0.4.11.1',
