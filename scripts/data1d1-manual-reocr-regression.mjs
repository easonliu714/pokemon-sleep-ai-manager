...
console.log(JSON.stringify({ok:true,gate:'v0.3.58 manual two-stage re-OCR',duplicate_force_override:true,general_scale:2,small_text_scale:4,summary_refreshed:true,contains_image_persistence:false}));
