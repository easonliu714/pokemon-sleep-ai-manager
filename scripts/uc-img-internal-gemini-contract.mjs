...
const promptSafetyAdapter=['uc-img-gemini-2026-08-15-c-prompt-safety-contract','uc-img-gemini-2026-08-17-d-live-recovery-schema','uc-img-gemini-2026-08-19-v042713-feature-model-capability'].includes(UC_IMG_GEMINI_ADAPTER_VERSION);
const liveSemanticAdapter=['uc-img-gemini-2026-08-17-d-live-recovery-schema','uc-img-gemini-2026-08-19-v042713-feature-model-capability'].includes(UC_IMG_GEMINI_ADAPTER_VERSION);
