...
Main Skill：活力全體療癒S、活力療癒S、活力填充S、能量填充S、能量填充M、料理成功率提升S、食材獲取S、幫手支援S、樹果數量S、夢之碎片獲取S、夢之碎片獲取M、揮指、流星群（樹果速增）、樹果速增、治癒波動、夢魘、樹果遞增、料理強化S、料理成功S、夢魘（能量填充M）、食材精選S、十項全能（揮指）、治癒波動（活力療癒S）、禮物（食材獲取S）、蓄力（能量填充S）
