...
assert.match(worker,/pokemon-sleep-ai-v0\.3\.64-g13-2f-region-ai-review-deferred/);
assert.match(worker,/update-center-live-debug\.js/);
console.log(JSON.stringify({ok:true,gate:'G13.2D duplicate-only finalize isolation and live debug compatibility',version:'v0.3.64'}));
