...
assert.match(bootstrap,/APP_VERSION = 'v0\.3\.67'/);assert.match(bootstrap,/20260803-g13-2i-progressive-ai-review-bootstrap/);assert.match(bootstrap,/lightweight_ai_review:true/);assert.match(bootstrap,/APP_VERSION = 'v0\.3\.65' 20260803-g13-2g-lightweight-ai-review/);assert.match(worker,/pokemon-sleep-ai-v0\.3\.67-g13-2i-progressive-ai-review-bootstrap/);assert.match(worker,/pokemon-sleep-ai-v0\.3\.65-g13-2g-lightweight-ai-review/);
console.log(JSON.stringify({ok:true,gate:'G13.2G lightweight AI review and export feedback compatibility',version:'v0.3.67',compatibility:'progressive-advanced-review'}));
