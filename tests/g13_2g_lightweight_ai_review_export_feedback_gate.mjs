...
assert.ok(wizard.indexOf('function createLightweightReview')<wizard.indexOf('createOcrRegionAiReviewPanel'),'lightweight review implementation must precede advanced review mounting');
assert.match(wizard,/single-item|single_item|selectedQueue|selectedItems/,'advanced review must retain a selected-item queue or single-item mounting contract');
