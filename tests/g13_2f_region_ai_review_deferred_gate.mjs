...
assert.doesNotMatch(wizard,/createOcrRegionAiReviewPanel\([^)]*\).*review-render-completed/s);
...
assert.match(wizard,/AI 覆核面板已改為手動載入/);
...
console.log(JSON.stringify({ok:true,gate:'G13.2F region AI review deferred',version:'v0.3.64'}));
