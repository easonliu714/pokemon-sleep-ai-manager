...
for(const token of ['loadRegionAiReviewBtn','optional-region-ai-review-ready','optional-region-ai-review-started','optional-region-ai-review-completed','optional-region-ai-review-failed'])assert.match(wizard,new RegExp(token));
...
assert.match(wizard,/AI 覆核面板採三階段載入/);
