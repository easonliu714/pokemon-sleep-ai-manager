...
assert.match(sw,/pokemon-sleep-ai-v0\.3\.63-g13-2e-finalize-nonblocking-workbench/);
...
console.log(JSON.stringify({ok:true,gate:'G13.2C compatibility',version:'v0.3.63'}));
