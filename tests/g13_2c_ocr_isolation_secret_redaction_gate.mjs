...
assert.match(sw,/pokemon-sleep-ai-v0\.3\.62-g13-2d-duplicate-finalize-isolation/);
...
console.log(JSON.stringify({ok:true,gate:'G13.2C compatibility',version:'v0.3.62'}));
