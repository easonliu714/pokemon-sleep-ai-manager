...
const PREVIOUS_CACHE_COMPATIBILITY_MARKERS=['pokemon-sleep-ai-v0.3.86-v0386-startup-progress-fail-open','pokemon-sleep-ai-v0.3.85-v0385-database-boot-isolation'];
void PREVIOUS_CACHE_COMPATIBILITY_MARKERS;
const ASSETS=['./','./index.html','./manifest.webmanifest','./assets/css/app.css','./assets/css/editor.css','./assets/js/bootstrap.js','./assets/js/runtime-version.js','./assets/js/debug-trace-manager.js','./assets/js/app.js','./assets/js/database.js','./assets/js/storage.js','./assets/js/v0382-release-authority.js','./assets/icons/icon.svg'];
