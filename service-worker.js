...
const APP_BUILD = '20260804-v0380-static-shell-runtime-authority';
const CACHE = 'pokemon-sleep-ai-v0.3.80-v0380-static-shell-runtime-authority';
...
const ASSETS = [
  ...
  './assets/js/runtime-version.js',
  './assets/js/debug-trace-manager.js',
  './assets/js/app.js',
  './assets/js/database.js',
  './assets/js/storage.js',
  './assets/js/backup-truth-restore.js',
  ...
  './assets/js/ai-key-vault.js',
  './assets/js/ai-project-pool-runtime.js',
  './assets/js/ai-project-pool-settings.js',
  './assets/js/ai-review-image-resolver.js',
  ...
  './assets/js/analysis-revision-store.js',
  './assets/js/analysis-confirmation-workbench.js',
  './assets/js/analysis-cross-check-confidence.js',
  ...
  './assets/js/identity-quality-guard.js',
  './assets/js/identity-dedup.js',
  './assets/js/identity-evidence-builder.js',
  './assets/js/identity-candidate-engine.js',
  './assets/js/sqlite-identity-candidate-adapter.js',
  './assets/js/identity-confirmation-model.js',
  './assets/js/identity-confirmation-ui.js',
  './assets/js/identity-confirmation-entry.js',
  './assets/js/identity-import-wizard.js',
  './assets/js/identity-import-pipeline.js',
  './assets/js/pokemon-screenshot-grouping.js',
  './assets/js/pokemon-zip-manifest.js',
  './assets/js/pokemon-zip-adapter.js',
  './assets/js/data1-zip-inventory.js',
  './assets/js/data1-image-fingerprint.js',
  './assets/js/data1d-local-ocr-runtime.js',
  './assets/js/ocr-runtime-monitor.js',
  './assets/js/data1d-ocr-first-classifier.js',
  './assets/js/data1d1-ocr-runtime-ui.js',
  './assets/js/data1d1-ocr-review-package.js',
  './assets/js/data1d1-ocr-region-ai-consent.js',
  './assets/js/data1d1-ocr-region-ui.js',
  './assets/js/data1d1-ocr-region-single-item-ui.js',
  './assets/js/data1d1-ocr-region-direct-minimal-hotfix.js',
  './assets/js/data1d1-manual-reocr.js',
  './assets/js/data1d1-ocr-thumbnail-region-confidence.js',
  './assets/js/data1d1-ocr-thumbnail-overlay-wiring.js',
  './assets/js/data1d1-ocr-overlay-lifecycle-events.js',
  './assets/js/data1d1-ocr-overlay-controller-integration.js',
  './assets/js/data1d1-ocr-overlay-update-center-mount.js',
  './assets/js/data1d1-ocr-overlay-update-center-bridge.js',
  './assets/js/data1d1-ocr-overlay-update-center-bootstrap.js',
  './assets/js/data1d1-ocr-overlay-preview-event-wiring.js',
  './assets/js/data1-inventory-review.js',
  './assets/js/data1-inventory-review-ui.js',
  './assets/js/jszip-loader.js',
  './assets/js/android-import-file-picker.js',
  './assets/js/screenshot-observation-bridge.js',
  './assets/js/identity-import-apply-operation.js',
  './assets/js/identity-import-transaction.js',
  './assets/js/identity-import-wizard-entry.js',
  './assets/js/update-center-ui-guard.js',
  './assets/js/update-center-live-debug.js',
  './assets/js/shared-master-schema.js',
  './assets/js/shared-master-data.js',
  './assets/js/public-empty-profile-master.js',
...
self.addEventListener('fetch', (event) => {
  ...
  const versionAuthorityAsset = sameOrigin && (
