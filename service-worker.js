...
const PREVIOUS_CACHE_COMPATIBILITY_MARKERS=[
  'pokemon-sleep-ai-v0.3.94-v0394-live-version-handoff-post-migration-watchdog',
  'pokemon-sleep-ai-v0.3.93-v0393-post-migration-startup-isolation',
  'pokemon-sleep-ai-v0.3.92-v0392-new-user-database-bootstrap-freeze',
  'pokemon-sleep-ai-v0.3.91-v0391-worker-lifecycle-race-closure',
...
const ASSETS=[
  './','./index.html','./manifest.webmanifest','./assets/css/app.css','./assets/css/editor.css','./assets/js/version-authority.js','./assets/js/bootstrap.js','./assets/js/runtime-version.js','./assets/js/debug-trace-manager.js','./assets/js/v0394-startup-watchdog.js','./assets/js/v0395-dom-render-scheduler.js','./assets/js/app.js','./assets/js/database.js','./assets/js/storage.js','./assets/js/sqlite-load-worker.js','./assets/js/v0390-worker-load-control.js','./assets/js/backup-truth-restore.js','./assets/js/data-consistency-multicapture.js','./assets/js/public-catalog-workbench.js','./assets/js/v0389-rescue-catalog-import.js','./assets/js/schema.js','./assets/js/migrations.js','./assets/js/importer.js','./assets/js/seed-data.js','./assets/js/pokemon-detail.js','./assets/js/pokemon-master-options.js','./assets/js/ai-observation.js','./assets/js/ai-workflow.js','./assets/js/ai-key-vault.js','./assets/js/ai-project-pool-runtime.js','./assets/js/ai-project-pool-settings.js','./assets/js/ai-review-image-resolver.js','./assets/js/ai-review-queue-executor.js','./assets/js/ai-review-executor-controller.js','./assets/js/ai-review-executor-status-ui.js','./assets/js/manual-editor.js','./assets/js/prompt-catalog.js','./assets/js/g3-planning.js','./assets/js/ingredient-gap-engine.js','./assets/js/time-utils.js','./assets/js/analysis-revision-store.js','./assets/js/analysis-confirmation-workbench.js','./assets/js/analysis-cross-check-confidence.js','./assets/js/two-stage-forced-ocr-entry.js','./assets/js/unified-import-analysis-workbench.js','./assets/js/full75-recovery-workbench.js','./assets/js/v0382-image-byte-snapshot.js','./assets/js/v0382-release-authority.js','./assets/js/v0383-catalog-ocr-review-contract.js','./assets/js/identity-review.js','./assets/js/identity-convergence.js','./assets/js/identity-quality-guard.js','./assets/js/identity-dedup.js','./assets/js/identity-evidence-builder.js','./assets/js/identity-candidate-engine.js','./assets/js/sqlite-identity-candidate-adapter.js','./assets/js/identity-confirmation-model.js','./assets/js/identity-confirmation-ui.js','./assets/js/identity-confirmation-entry.js','./assets/js/identity-import-wizard.js','./assets/js/identity-import-pipeline.js','./assets/js/pokemon-screenshot-grouping.js','./assets/js/pokemon-zip-manifest.js','./assets/js/pokemon-zip-adapter.js','./assets/js/data1-zip-inventory.js','./assets/js/data1-image-fingerprint.js','./assets/js/data1d-local-ocr-runtime.js','./assets/js/ocr-runtime-monitor.js','./assets/js/data1d-ocr-first-classifier.js','./assets/js/data1d1-ocr-runtime-ui.js','./assets/js/data1d1-ocr-review-package.js','./assets/js/data1d1-ocr-region-ai-consent.js','./assets/js/data1d1-ocr-region-ui.js','./assets/js/data1d1-ocr-region-single-item-ui.js','./assets/js/data1d1-ocr-region-direct-minimal-hotfix.js','./assets/js/data1d1-manual-reocr.js','./assets/js/data1d1-ocr-thumbnail-region-confidence.js','./assets/js/data1d1-ocr-thumbnail-overlay-wiring.js','./assets/js/data1d1-ocr-overlay-lifecycle-events.js','./assets/js/data1d1-ocr-overlay-controller-integration.js','./assets/js/data1d1-ocr-overlay-update-center-mount.js','./assets/js/data1d1-ocr-overlay-update-center-bridge.js','./assets/js/data1d1-ocr-overlay-update-center-bootstrap.js','./assets/js/data1d1-ocr-overlay-preview-event-wiring.js','./assets/js/data1-inventory-review.js','./assets/js/data1-inventory-review-ui.js','./assets/js/jszip-loader.js','./assets/js/android-import-file-picker.js','./assets/js/screenshot-observation-bridge.js','./assets/js/identity-import-apply-operation.js','./assets/js/identity-import-transaction.js','./assets/js/identity-import-wizard-entry.js','./assets/js/update-center-ui-guard.js','./assets/js/update-center-live-debug.js','./assets/js/shared-master-schema.js','./assets/js/shared-master-data.js','./assets/js/public-empty-profile-master.js','./assets/js/canonical-registry.js','./assets/js/shared-knowledge-ui.js','./assets/js/recipe-render-guard.js','./assets/icons/icon.svg'
];
...
self.addEventListener('fetch',event=>{
  ...
  const authorityAsset=sameOrigin&&(url.pathname.endsWith('/version-authority.js')||url.pathname.endsWith('/service-worker.js')||url.pathname.endsWith('/bootstrap.js')||event.request.mode==='navigate');
  const networkFirst=sameOrigin&&(authorityAsset||url.pathname.endsWith('.js')||url.pathname.endsWith('.html'));
